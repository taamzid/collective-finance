...
const PrivacyPolicy = () => {
  return (
    <div className="terms">
      <h1>Privacy Policy for EZ Wallet</h1>
      <p>Version 1.0.0 2022</p>
      <p>
        At EZ Wallet, accessible from https://ezwallet.the-labz.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        EZ Wallet and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in EZ Wallet. This policy is not applicable to any
      ...
      <p>
        ...
        you emails Find and prevent fraud Log Files EZ Wallet follows a standard
      ...
      <p>
        Like any other website, EZ Wallet uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of EZ Wallet.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on EZ Wallet, which are sent
      ...
      <p>
        Note that EZ Wallet has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
      <h3>Third Party Privacy Policies</h3>
      <p>
        EZ Wallet's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        EZ Wallet does not knowingly collect any Personal Identifiable
